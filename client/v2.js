...
Template.vueParticipantV2.onCreated(function helloOnCreated() {
	moment.locale('fr')
	// shuffle(allAudio);
...
Template.contentV2.onRendered(function yo(){
...
Template.formV2.helpers({
	when:function(){
		return Session.get("time");
	}
})

Template.vueParticipantV2.events({
